...
import com.example.shuftipronfc.Helpers;
...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doc2RelativeLayout = findViewById(R.id.docTwoRelativeLayout);
        ...
        doc2CheckImageView = findViewById(R.id.docTwoCheckImageView);
    ...
    public void onClick(View v) {
        ...
        if (v == continueButton) {
            ...
            if (!isFaceChecked && !isDocChecked && !isAddressChecked && !isDocTwoChecked && !isConsentChecked && !isPhoneChecked && !isBgChecked) {
