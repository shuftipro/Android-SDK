...
dependencies {
       ...
       implementation 'com.github.shuftipro:Android-OCR-Verification:1.0.1'
}
```
...
<dependency>
	    ...
	    <artifactId>Android-OCR-Verification</artifactId>
...
```
Now you are required to perform a method call for all the verification services that you want to perform and for those authentication services that are not desired to be performed, pass a ```null``` value.
